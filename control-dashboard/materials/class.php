...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        if ($check_result->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                logActivity($_SESSION['user_id'], 'Add Class', "Added Class: $name");
                $success = "Class added successfully!";
                $name = '';
                $description = '';
            } else {
                $error = "Failed to save new class to database!";
            }
        }
    }
}

logActivity($_SESSION['user_id'], 'Add Class', 'Accessed add Class page');
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="main-content">
            ...
            <div class="content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fas fa-folder-plus me-2"></i>Add Classes</h2>
